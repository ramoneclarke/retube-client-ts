...
const DashSummariesTile = () => {
  return (
    <div className="flex h-full w-1/3 flex-row items-center gap-2 rounded-xl bg-lightest/50 p-4 shadow-lg dark:border dark:border-dark/20 dark:bg-darker/70">
      <div className="relative h-full w-2/5 overflow-hidden rounded-xl">
        <Image
          src={`https://img.youtube.com/vi/WhCXiEwdU1A/maxresdefault.jpg`}
          fill
...
export default DashSummariesTile;
