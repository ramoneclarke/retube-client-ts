...
const SummariesDetails = ({ userData, isMobile }) => {
  ...
  return (
    <div className="mb-6 flex h-[20vh] w-full flex-col items-center gap-y-8 rounded-lg bg-lightest p-3 shadow-md dark:bg-slate-800 md:h-fit md:min-h-[30vh] md:p-6 lg:min-h-0 lg:w-4/5 lg:p-8">
      <div className="flex h-full w-full flex-row items-center justify-start gap-3 md:flex-row md:gap-8 lg:flex-row lg:px-0">
        <SummariesDetail
          label="Usage"
