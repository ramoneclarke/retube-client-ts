...
const NewSnippetWindow = ({
  ...
  if (maxUsage) {
    return (
      <motion.div
        className="absolute top-2 right-0 z-20 flex h-[98%] w-[98vw] flex-col overflow-y-scroll rounded-xl bg-slate-200 p-4 shadow-lg dark:bg-darker lg:top-4 lg:h-full lg:w-4/5 lg:p-6"
        initial={{ x: 1500 }}
        animate={{ x: 0 }}
        exit={{ x: 1500 }}
